...
// src/QuestlogBadge.sol

/**
 * @title QuestlogBadge
 * @dev Soulbound NFT Badge for on-chain achievements, non-transferable except minting/burning
 */
contract QuestlogBadge is ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIdCounter;

    // Addresses authorized to mint badges
    ...
    /**
     * @dev Initialize with token name and symbol
     */
    ...
    /**
     * @dev Owner can authorize a new minter
     */
    ...
    /**
     * @dev Owner can revoke minter rights
     */
    ...
    /**
     * @dev Mint a new soulbound badge to `to` with metadata URI
     */
    ...
    /**
     * @dev Prevent any transfer except minting (from==0) or burning (to==0)
     */
    ...
    /**
     * @dev Allow holder or owner to burn a badge
     */
    ...
    /**
     * @dev Support interfaces from inherited contracts
     */
...
/**
 * @title QuestMinter
 * @dev Handles quest completion verification and automatic badge minting
 * Allows flexible quest completion without pre-registration
 */
contract QuestMinter is Ownable {
    QuestlogBadge public immutable questlogBadge;
    
    // Track completed quests per user
    ...
    constructor(address _questlogBadge) {
        questlogBadge = QuestlogBadge(_questlogBadge);
    }
    
    /**
     * @dev Complete a quest and mint badge with metadata
     * @param questId Unique identifier for the quest
     * @param badgeURI Metadata URI for the badge NFT
     */
    ...
    /**
     * @dev Check if user has completed a specific quest
     */
    function getHasCompletedQuest(bytes32 questId, address user) external view returns (bool) {
        return hasCompletedQuest[user][questId];
    }
}
